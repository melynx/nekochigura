...
# fix_riscv.patch (bug #979046) is dropped: rakshasa/libtorrent#778 landed
# upstream, so scripts/common.m4 already carries the riscv32/riscv64 case (and
# loongarch besides). The old patch still applies with fuzz and would insert a
