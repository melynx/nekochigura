...
multilib_src_compile() {
	# Gentoo's multi-implementation xcb-proto cannot publish one Python
	# site-packages path. Use the interpreter selected by python-any-r1.
	emake XCBPROTO_XCBPYTHONDIR="$(python_get_sitedir)"
}
