...
SRC_URI="
	amd64? (
		https://downloads.1password.com/linux/tar/stable/x86_64/${MY_PN}-${MY_PV}.x64.tar.gz
			-> ${P}-amd64.tar.gz
	)
	arm64? (
		https://downloads.1password.com/linux/tar/stable/aarch64/${MY_PN}-${MY_PV}.arm64.tar.gz
			-> ${P}-arm64.tar.gz
	)
	cli? (
		amd64? (
