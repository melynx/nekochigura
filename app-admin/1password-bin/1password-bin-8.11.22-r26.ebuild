...
SRC_URI="
	amd64? ( https://downloads.1password.com/linux/tar/beta/x86_64/${MY_PN}-${MY_PV}.26.x64.tar.gz -> ${P}-amd64.tar.gz )
	arm64? ( https://downloads.1password.com/linux/tar/beta/aarch64/${MY_PN}-${MY_PV}.26.arm64.tar.gz -> ${P}-arm64.tar.gz )
	cli? (
