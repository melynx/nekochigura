...
SRC_URI="
	https://github.com/pando85/passless/archive/refs/tags/v${PV}.tar.gz
		-> ${P}.tar.gz
	${CARGO_CRATE_URIS}
"
...
src_configure() {
	...
	# Let Portage perform the final stripping.
...
pkg_postinst() {
	...
	elog "  - filesystem: Local storage (testing only)"
	if use tpm; then
